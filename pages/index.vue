      ...
      <div class="md:w-[540px] mx-auto pt-28">
        ...
        <div class="bg-white mt-5 rounded p-4 drop-shadow-2xl">
          <div class="w-full pl-1 flex items-center w-full">
            ...
            <input type="text" ref="todoInput" v-model="newTodo" placeholder="Create a new to do..." v-on:keyup.enter="makeNewTodo()" class="focus:outline-0 w-full p-1 pt-2 ml-3 text-lg">
          </div>
        </div>
        ...
        <div class="mx-auto text-center mt-12 text-xs pb-10">
          <div class="flex justify-center">
            <div class="form-check form-switch">
              ...
              <label class="form-check-label pt-1 inline-block text-sm text-gray-800" for="flexSwitchCheckChecked">
